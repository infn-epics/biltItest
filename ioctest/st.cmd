...
dbLoadRecords("$(TOP)/db/unimag-biltItest.db","device=$(PREFIX):HCOR06,port=TEST,module=1,max=10")

dbLoadRecords("$(TOP)/db/biltItest.template","device=$(PREFIX):VCOR06,port=TEST,module=2,max=10")
dbLoadRecords("$(TOP)/db/unimag-biltItest.db","device=$(PREFIX):VCOR06,port=TEST,module=2,max=10")

dbLoadRecords("$(TOP)/db/biltItest.template","device=$(PREFIX):HCOR07,port=TEST,module=3,max=10")
dbLoadRecords("$(TOP)/db/unimag-biltItest.db","device=$(PREFIX):HCOR07,port=TEST,module=3,max=10")

dbLoadRecords("$(TOP)/db/biltItest.template","device=$(PREFIX):VCOR07,port=TEST,module=4,max=10")
dbLoadRecords("$(TOP)/db/unimag-biltItest.db","device=$(PREFIX):VCOR07,port=TEST,module=4,max=10")
